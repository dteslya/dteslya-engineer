...
In the [first entry](creating-vm-templates-with-packer.md) of this series I showed how to create VM templates using Packer. Now we can use those templates to spin up actual VMs with help of Terraform.
...
!!!note ""
    It is considered best practice to add `terraform.tfvars` to `.gitignore` file to avoid leaking of sensitive data to version control system.
